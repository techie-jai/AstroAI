      ...
      <div className="relative cosmic-card rounded-2xl overflow-hidden">
        ...
        <div className="divide-y divide-border/30">
          {analyses.map((analysis, index) => (
            <div
              key={analysis.id}
              className="group flex items-center justify-between p-5 hover:bg-purple-500/5 transition-all duration-300"
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-foreground group-hover:text-purple-300 transition-colors">
                    {analysis.name}
                  </h3>
              ...
              <div className="flex items-center gap-3">
                <Link href={`/results/${analysis.id}`}>
                  <Button className="bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 gap-2 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25 hover:scale-105">
                    <Eye className="w-4 h-4" />
                    View
                  </Button>
                </Link>
                <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 gap-2 font-medium transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25 hover:scale-105">
