...
const features = [
  { text: "Accurate Vedic calculations", icon: "calc" },
  { text: "AI-powered insights", icon: "ai" },
  { text: "Chat with your kundli", icon: "chat" },
  { text: "Download PDF reports", icon: "pdf" },
]
