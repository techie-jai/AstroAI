      ...
      <div className="relative w-full max-w-md mx-4">
        <div className="p-8 rounded-2xl border border-border bg-card/80 backdrop-blur-xl shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-primary hover:bg-primary/90 disabled:bg-primary/50 glow-purple gap-3 h-12 text-base text-primary-foreground font-semibold py-3 px-4 rounded-lg transition flex items-center justify-center"
          >
            {loading ? (
              <>
