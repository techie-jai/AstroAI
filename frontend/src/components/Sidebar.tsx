...
import { ChevronLeft, ChevronRight, LayoutDashboard, BookOpen, Sparkles, MessageCircle, Settings, LogOut, AlertCircle, Heart, Hand } from 'lucide-react'
...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
  ...
  const navItems = [
    ...
    { path: '/palmistry', label: 'Palmistry', icon: Hand },
