...
async def generate_analysis(
    ...
    try:
        ...
        analysis_text = f"AI Analysis for {user_name}'s Kundli\n\n"
        analysis_text += "This is a placeholder analysis. In production, this would be generated by Gemini API.\n"
        analysis_text += f"Kundli ID: {request.kundli_id}\n"
        analysis_text += f"Analysis Type: {request.analysis_type}\n"
